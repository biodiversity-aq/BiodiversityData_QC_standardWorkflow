...
#data QC code develloped by the biodiversity.aq team
...
obistools::check_eventids(coreEvent)
...
extOccur$scientificName <- gsub("gen nov.", "", extOccur$scientificName, fixed=T)
extOccur$scientificName <- gsub(" sp.", "", extOccur$scientificName)
extOccur$scientificName <- gsub("^ ", "", extOccur$scientificName)
...
# move the data from the taxid_key to the occurrences
for(term in setdiff(colnames(taxid_key), c("taxname", "aphID", colnames(extOccur)))){
  extOccur[,term]  <- as.character(extOccur$scientificName)
  extOccur[,term] <- unname(unlist(sapply(as.character(extOccur[,term]), 
                                                               FUN = function(x){                                                 gsub(x,taxid_key[taxid_key$taxname==x,][,term],x)
                                                            })))
}
